 ...
 * {@link FragmentAnalysis.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentAnalysis#newInstance} factory method to
...
public class FragmentAnalysis extends Fragment {
    ...
    public static FragmentAnalysis newInstance(String param1, String param2) {
    ...
    public void onActivityCreated( Bundle savedInstanceState) {
        ...
        bt1=(Button)getActivity().findViewById(R.id.button);
